 ...
 * @author Tim Lavers
 */
public class PauseOnExceptionForUnitTestMethod extends FTBase {

    public boolean runTest() throws Exception {
        //Create a GrandTestAuto to run just the unit test configured in tests132.zip.
        File settingsFile = Helpers.expandZipWithSeparateSourceAndClassRootsAndWriteSettingsFileForUnitTestsOnly(new File(Grandtestauto.test132_zip));
        ...
        Assert.azzert(testsRun.contains("a132.a.test.ATest"));
